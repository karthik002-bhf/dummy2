...
function HomePage() {
    return (
        <div className=''>
            <div style={{ backgroundImage: 'url(/Images/bhf_college_banner.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', height: '70vh', textAlign: 'center' }} data-aos="fade-up">
            ...
            <div className='container-fluid' data-aos="fade-up">
                ...
                <div className='text-center py-5 bg-light' data-aos="fade-up">
                    <h1>Our Services</h1>
                    <div className='col-md-12 row mx-0 d-flex justify-content-between'>
                        <div className='col-md-4 bg-white p-1' data-aos="fade-up">
                        ...
                        <div className='col-md-4 col-md-3 bg-white p-1' data-aos="fade-up">
                            <div className='m-1 shadow-md rounded text-center'>
                                <div className='img_div'>
